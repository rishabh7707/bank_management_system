...
void admin()
{
    ...
    if(strcmp(uname,"INSPARK")==0&&strcmp(pass,"SRPS")==0) c=1;
    else
    {
        title();
        gotoxy(25,10); printf("Invalid User name or Password!\a");
...
void welcome()
{
    ...
    system("cls");
    rectangle(0,0,80,23);
    gotoxy(35,2); printf("EXCALIBUR");
    gotoxy(34,3); for(i=0;i<11;i++) printf("%c",196);
    ...
    gotoxy(33,11); printf("Suyash Agrawal");
    gotoxy(33,13); printf("Rishabh Kumar");
    gotoxy(33,15); printf("Pranjal Prateek");
    gotoxy(33,17); printf("Sarad Chhetri");
    gotoxy(24,20);
